...
public class Bingo extends UnicastRemoteObject implements BingoInterface {
    ...
    public int Play(int clientID, int guessedNumber) throws RemoteException {
    ...
    public int GetBestScore(int clientID) throws  RemoteException {
        if(!_clientGames.containsKey(clientID))
            return 0;
    ...
    public List<Integer> GetClientHistory(int clientID) throws RemoteException {
